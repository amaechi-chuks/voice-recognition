			...
			<div className="collapse navbar-collapse" id="navbarToggler">
             <ul className="navbar-nav ml-auto">
                 ...
                 <li className="nav-item">
                     ...
                     <li class="nav-item" >
                        <a class="nav-link" rel="tooltip" title="Follow me on Medium" data-placement="bottom" href="https://medium.com/@amaechichuks2000" target="_blank" rel="noopener noreferrer">
